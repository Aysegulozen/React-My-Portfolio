...
import emailjs from 'emailjs-com'; // emailjs kütüphanesini doğru şekilde içe aktardık
import { Card, Button } from 'flowbite-react'; // Flowbite React'ten Card ve Button bileşenlerini içe aktarıyoruz
import { FaLinkedin, FaGithub, FaTwitter } from 'react-icons/fa';
import { FiPhone, FiMail, FiMapPin } from 'react-icons/fi';


const ContactUs = () => {
  const form = useRef(); // Form referansını oluşturuyoruz
  ...
  const sendEmail = (e) => {
    ...
    .then((response) => {
      ...
      alert('Your message has been received.'); // Başarılı bir şekilde gönderildiğinde bir bildirim göster
      ...
      <div className="w-full max-w-lg">
        <div className="p-8 text-white">
          <div className="flex flex-col space-y-4">
            <p className="text-center text-2xl">Have any questions or suggestions? Feel free to reach out to us!</p>
            <div className="w-24 border-b border-gray-400 mx-auto mb-6"></div>
