            ...
            <div className="w-2/3 p-8">
                <div className="max-w-lg">
                    ...
                    <div className="flex justify-between items-center mb-4">
                        <a href="https://drive.google.com/uc?export=download&id=1ZirGV5AZU6QRQghphrAan2M2vlLtPW9J" download="CV_Aysegul_Ozen.pdf" className="border border-black text-black px-4 py-2 rounded-lg text-lg hover:bg-green-600">Download CV</a>
                    </div>
